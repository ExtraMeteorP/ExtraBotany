...
import static com.meteor.extrabotany.common.integration.minetweaker.utils.InputHelper.toStack;
...
public class StackHelper {
	...
	public static boolean areEqual(ItemStack stack1, ItemStack stack2) {
		if (stack1 == null || stack2 == null) {
			return false;
		} else if (MinetweakerCompact.isSubtile(stack1) && MinetweakerCompact.isSubtile(stack2)) {
			return MinetweakerCompact.subtileMatches(stack1, stack2);
		} else {
    ...
    public static boolean matches(IIngredient ingredient, IItemStack itemStack) {
        ...
        if(ingredient.getItems() != null && MinetweakerCompact.isSubtile(toStack(itemStack))) {
