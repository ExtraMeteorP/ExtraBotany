...
public class LibLexiconName {
	...
	public static final String FFLOWER_WOODIENIA = "woodienia";
	public static final String FFLOWER_ICEBIRDIUM = "icebirdium";
	...
	//Relics
	public static final String R_HESTIACHASTITY = "hestiachastity";
	public static final String R_MAXWELLDEMON = "maxwelldemon";
	public static final String R_ATHENABLESS = "athenabless";
	public static final String R_APHRODITEGRACE = "aphroditegrace";
	public static final String R_DICE20 = "dice20";
	public static final String R_EXCALIBER = "excaliber";
	public static final String R_EXCALIBERFAKE = "excaliberfake";
	public static final String R_VPOWERBATTLEAXE = "vpowerbattleaxe";
	public static final String R_VHANDGUN = "vhandgun";
	public static final String R_VRANGERBOOTS = "vrangerboots";
