...
public class ExplosionMagic extends Explosion{
            ...
            if (d4 <= 1.0D)
            {
                ...
                if (d9 != 0.0D)
                {
                    ...
                    if(!(entity instanceof EntityPlayer) || !(entity instanceof EntityItem)){
	                    entity.attackEntityFrom(DamageSource.magic, (float)((int)((d11 * d11 + d11) / 2.0D * 8.0D * (double)this.explosionSize + 1.0D)));
	...
	public void doExplosionB(boolean p_77279_1_)
    {
        ...
        {
        	for(int i = 0; i < 16; i++)
        		Botania.proxy.wispFX(this.worldObj, this.explosionX + Math.random() * 2F - 2F, this.explosionY  + 0.65F + Math.random() * 2F - 2F, this.explosionZ + Math.random() * 2F - 2F, 2.32F, 2.32F, 0.85F, 3.12F, 0F, 0.45F);
        }
        else
        {
        	for(int i = 0; i < 16; i++)
        ...
        if (this.isSmoking)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                if (p_77279_1_)
                {
                    ...
                    d5 *= d7;
                    for(int b = 0; b < 34; b++){
                    	Botania.proxy.wispFX(this.worldObj, (d0 + this.explosionX * 1.0D) / 2.0D, (d1 + this.explosionY * 1.0D) / 2.0D + 0.65F, (d2 + this.explosionZ * 1.0D) / 2.0D, 2.3F, 1.0F, 1.0F , 1.3F, 0F, 0.55F);
                    	Botania.proxy.wispFX(this.worldObj, d0, d1 + 0.65F, d2,  2.3F, 1.0F, 1.0F , 1.3F, 0F, 0.55F);
                    }
                }
